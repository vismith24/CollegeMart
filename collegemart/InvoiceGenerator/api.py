...
class Address(UnicodeProperty):
    ...
    :param phone:
    :param email:
    :param payment_method: bank account number
...
class Invoice(UnicodeProperty):
    ...
    def __init__(self, client, provider, creator, order_id):
...
class QrCodeBuilder(object):
    ...
    def _fill(self, invoice):
        ...
        qr_kwargs = {
            'account': invoice.provider.payment_method,
